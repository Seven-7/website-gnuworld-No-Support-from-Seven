...
echo "<!-- $Id: susp_users.php,v 1.12 2005/11/18 04:19:33 nighty Exp $ //-->";
...
echo "<tr><td colspan=4><H2>Globally suspended users ";
if ($_GET["ok"]==1) { echo "(custom)</h2> <a href=\"susp_users.php\">View last " . $X_DAYS . " days</a>"; } else { echo "(last " . $X_DAYS . " days)</h2>"; }
echo "<br>";
...
if ($date_is_valid) {
	if (pg_numrows($res)==0) {
		echo "<tr><td align=center><font color=#" . $cTheme->table_headcolor . " size=+1><b>No suspended users found for this period.</b></font></td></tr>";
	} else {
