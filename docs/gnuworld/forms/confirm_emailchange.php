...
if ($ID!="" && strlen($ID)<=128) {
	...
	echo "<html><head><title>Email Change Confirmation</title>";
	std_theme_styles();
	echo "</head>";
	std_theme_body("../");
	echo "<form method=POST><h1>Email Change Confirmation</h1>Please enter the ID you recieved in the email below.";
	echo "<input type=text name=ID size=50 maxlength=128><br><input type=submit value=\"Complete Email Change\">";
	echo "</form></body></html>";
}
