...
if (pg_numrows($res2)>1 && $multiple==1 && isset($forcechannel) && $forcechannel!="" && ereg("^#",$forcechannel_C) && $forcechannel_I>1) {
...
<ol>
 ...
 <li>Your email: <b><? echo $user->email ?></b><input type=hidden name=email value=<? echo $user->email ?>>
<? if ($multiple_ok == 0) { ?>
