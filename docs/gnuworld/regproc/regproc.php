<?
/* $Id: regproc.php,v 1.26 2007/10/06 06:24:26 nighty Exp $ */
...
if ( strcspn($channel_nameF,$control_chars)!=strlen($channel_nameF) || ereg(",",$channel_nameF) ) {
	echo "The channel name can't contain any <b>space</b>, <b>null</b> , <b>comma (,)</b> or <b>control chars</b>.<br>\n";
...
if ((strtolower($channel_nameF) != C_strtolower($channel_nameF)) || (strtoupper($channel_nameF) != C_strtoupper($channel_nameF))) {
